...
banner() {
    echo ""
    echo -e "${M}        ___${N}"
    echo -e "${M}       /   \\${N}        ${G}                 _ _       _${N}"
    echo -e "${M}      / ${Y}★${M}   \\${N}       ${G} _ __ ___   ___ | (_)_ __ | |_${N}"
    echo -e "${M}     /______\\${N}      ${G}| '_ \` _ \\ / _ \\| | | '_ \\| __|${N}"
    echo -e "${M}     ${C}(${N}${D}••${N}${Y}▸${C})${N}        ${G}| | | | | |  __/| | | | | | |_ ${N}"
    echo -e "${M}     {${W}~~~~${M}}${N}        ${G}|_| |_| |_|\\___||_|_|_| |_|\\__|${N}"
    echo -e "${Y}    ┌${G}┤${D}>_ ${G}├┐${N}"
    echo -e "${Y}    └──────┘${N}       ${D}Agent Token Optimizer  v0.1.10${N}"
    echo ""
}
